# sync rom
repo init --depth=1 --no-repo-verify -u https://github.com/BiancaProject/android.git -b 13-meme -g default,-mips,-darwin,-notdefault
...
git clone --depth=1 https://${LAB_KEY}@gitlab.com/BiancaProject/vendor_xiaomi_miuicamera -b leica vendor/xiaomi/miuicamera
